...
- `sub-1001/accel/ses-1/output_ses-1/results/part5_daysummary_fixture.csv`
  - 2 valid daily rows
- `sub-2002/accel/ses-2/output_ses-2/results/part5_daysummary_fixture.csv`
  - 1 valid daily row
- `sub-3003/accel/ses-1/output_ses-1/results/part5_daysummary_invalid.csv`
